...
use spl_token_2022::extension::{transfer_fee::TransferFeeConfig, BaseState, BaseStateWithExtensions, StateWithExtensionsMut};
use std::ops::Mul;
...
// pub fn get_transfer_inverse_fee<'data, S: BaseState>(account_state: &StateWithExtensionsMut<'data, S>, epoch: u64, post_fee_amount: u64) -> u64 {
...
pub fn get_transfer_fee<'data, S: BaseState>(account_state: &StateWithExtensionsMut<'data, S>, epoch: u64, pre_fee_amount: u64) -> u64 {
    let fee = if let Ok(transfer_fee_config) = account_state.get_extension::<TransferFeeConfig>() {
